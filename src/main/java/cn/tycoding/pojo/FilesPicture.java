...
public class FilesPicture {
    ...
    public FilesPicture (Integer expid, String url, Integer id_query, String file_name) {
    	this.expid = expid;
    	this.url = url;
	...
	public String toString() {
		return "FilesPicture [expid=" + expid + ", url=" + url + ", id_query=" + id_query + ", files_name=" + files_name
				+ "]";
	}
